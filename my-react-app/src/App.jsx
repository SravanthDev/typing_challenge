...
function App() {
  ...
  const hardWords = ["The mitochondria is the powerhouse of the cell", "The quick brown fox jumps over the lazy dog", "Supercalifragilisticexpialidocious is easier than this"]
